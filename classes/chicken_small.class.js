...
class ChickenSmall extends MovableObject {
    ...
    /**
     * Creates a small jumping chicken.
    ...
    /**
     * Starts randomized recurring jumps.
     * @returns {void}
     */
    startJumping() {
    ...
    /**
     * Starts a jump when the chicken is ready.
     * @returns {void}
     */
    jumpWhenReady() {
    ...
    /**
     * Starts the small chicken's gravity loop.
     * @returns {void}
     */
    applyGravity() {
    ...
    /**
     * Places the chicken on the ground.
     * @returns {void}
     */
    landOnGround() {
        this.y = this.groundY;
    ...
    /**
     * Checks whether the chicken is airborne.
